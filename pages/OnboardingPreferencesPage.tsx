...
export const OnboardingPreferencesPage: React.FC = () => {
  ...
  const onSubmit = (data: OnboardingPreferences) => {
    // FIX: The `onboardingPreferences` and `profileCompleted` properties must be nested inside a `profile` object to match the expected payload structure.
    updateProfileMutation.mutate({ 
        profile: {
            onboardingPreferences: data,
            profileCompleted: true, // Mark onboarding as complete
        }
    });
  };
